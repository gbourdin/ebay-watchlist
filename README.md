...
## Release Automation
`/.github/workflows/ci.yml` and `/.github/workflows/release.yml` handle automated releases:
- Every push to `main` runs CI checks. If checks pass, CI creates and pushes the next SemVer tag (`vX.Y.Z`) automatically.
