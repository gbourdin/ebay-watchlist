...
- `uv run ebay-watchlist cleanup-expired-items --retention-days 30`: delete items ended before retention window.
- `uv run ebay-watchlist run-loop --cleanup-retention-days 30 --cleanup-interval-minutes 1440`: daemon fetch + periodic retention cleanup.
